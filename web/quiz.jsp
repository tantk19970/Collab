                ...
                <div class="row">
                        ...
                        <div class="card text-center">
                            ...
                            <div class="container d-flex justify-content-center flex-wrap">
                                <div v-for="(item,index) in quizQ">
                                    <a type="button" class="btn btn-outline-success jump-to-button"
                                        :href="'#q'+item.questionId">{{item.questionId}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-9" id="quizQuestion">
                        <div class="row" v-for="(item,index) in quizQ" v-bind:key="index">
                            <div class="card col-md-2 p-3 d-inline-block mx-1"
                                style="max-height: 7rem;max-width: 10rem; background: #eeeeee">
                                Question <span class="fs-4 fw-bold">{{item.questionId}}</span>
                            </div>
                            <div class="card p-3 rounded-3 col-md-10 mb-4" :id="'q'+item.id"
                                ...
                                <div class="form-check" v-for="(anAnswer,index2) in item.answers" v-bind:key="index2">
                                    <input class="form-check-input" type="radio"
                                        :name="'quizAnswerNo'+anAnswer.answerId">
